<template>
  <div>
    <section class="l-section">
      <template v-if="cardList.length > 0">
        ...
        <div v-if="radio.value === 2" class="l-amount">
          <p class="info">
            분할보험금 발생일 NN일 전 계약은 미리 예약하실 수 있습니다. 예약할 계약을 선택해주세요.
          </p>
    ...
    >
      <template #content>
        <div style="padding:3rem 2rem">
          분할보험금은 해당 지급금 발생일까지 보험료를 정상적으로 납부하셨을 경우 지급금 발생일 (주말/휴일인 경우 익영업일)에 지급됩니다.
          <div class="gray-box">
    ...
    <base-modal :show-close="false" :visible.sync="dialog.confirmPop" type="system" width="280px">
      <template #content>
        <p class="message">
          분할보험금 지급 예약 중인<br>계약 입니다.<br>예약을 취소하시겠습니까?
        </p>
      </template>
      <template #footer>
        <div class="btn-group">
