<template>
  <div>
    <section class="l-section gap-both">
      <check-list :list.sync="list" />
    </section>
    <div class="l-bottom">
      <base-buttons type="navy" size="medium" full @click="agreeModal = true">
        모두 동의
      </base-buttons>
    </div>
    <base-modal
    ...
    >
      <template #content>
        <section class="l-section gap_top">
          ...
          <base-messagebox :box="terms1">
            <terms-typo type="desc">
              ...
              책임준비금을 재원으로 시행하게 됩니다. 이에 따라, 보험계약대출이율
              가산금리는 회사의 운용자산이익률과 금융시장여건, 대출금관리비용,
              시중의 대출이율수준 등을 고려하여 결정하게 됩니다.
            </terms-typo>
          </base-messagebox>
          ...
          <base-messagebox :box="terms2">
            ...
            <terms-typo type="desc">
              ...
              가산금리가 명시되어 있으므로 가산금리 자체의 변경은 없습니다. 단,
              종신보험의 공시이율은 분기마다 시장수익률을 반영하여 분기마다 재
              산출 / 적용되므로 대출이율도 연동하여 변동됩니다.
            </terms-typo>
          </base-messagebox>
        ...
        <section class="l-section">
          ...
          <base-messagebox :box="terms5">
            <terms-typo type="bullet">
              대출기간 : 보험계약대출 대상 계약의 보험기간 (연금보험은 연금 개시
              전 / 2005년 4월 1일 이후 계약은 효력상실임)
            </terms-typo>
            <terms-typo type="bullet">
            ...
            <terms-typo type="bullet">
              [금리연동형] 산정기준 : 공시이율 + 1.5% (대출신청일기준, 매월변동)
            </terms-typo>
            <terms-typo type="bullet">
              [확정금리형] 산정기준 : 공시이율 + 1.5%
            </terms-typo>
          ...
          <base-messagebox :box="terms7">
            <terms-typo type="desc">
              ...
              효력상실일까지로 한다) 내로 하되, 본인은 언제라도 보험계약대출금을
              상환할 수 있다.
            </terms-typo>
          </base-messagebox>
          ...
          <base-messagebox :box="terms8">
            <terms-typo type="desc">
              (1) 보험계약대출의 이자율 등은 회사가 정하는 바에 따르며, 이자율이
              변경되는 경우 변경일 이후의 기간에 변경된 이자율을 적용한다.
            </terms-typo>
            <terms-typo type="desc">
              (2) 보험계약대출이자는 은행자동이체 납부를 원칙으로 하되 즉시출금,
              가상계좌를 이용할 수 있고, 일단위로 계산하여 매월 대출이자
              납입응당일(이하 "이자납부일"이라 한다)에 납부하는 것을 원칙으로
              한다. (단, 납입응당일이 공휴일인 경우 그 익영업일로 한다)
            </terms-typo>
            <terms-typo type="desc">
          ...
          <base-messagebox :box="terms9">
            <terms-typo type="desc">
              (1) 다음의 각호에서 정한 사유가 발생한 경우에는 즉시 보험계약대출
              원금과 이자를 변제하기로한다. 단, 회사에서 연장을 승인한 경우에는
              기한의 이익을 상실하지 않는다.
            </terms-typo>
            <terms-typo type="desc">
              ①보험계약대출대상계약의 보험기간이 만료되거나 대상계약이 무효로 된
              때
            </terms-typo>
            <terms-typo type="desc">
            ...
            <terms-typo type="desc">
              ...
              보험계약대출의 경우 대상 보험계약이 보험료 미납을 이유로 해지되고
              보험계약대출원리금 합계액이 해지환급금을 초과한 때
            </terms-typo>
            <terms-typo type="desc">
            ...
            <terms-typo type="desc">
              ...
              )하여 해지환급금과 보험계약대출원리금을 상계( 해 지 환 급 금 과 보
              험 계 약 대 출 원 리 금 을 상 계 )할 수 있다.
            </terms-typo>
            <terms-typo type="desc">
          ...
          <base-messagebox :box="terms10">
            <terms-typo type="desc">
              보험계약대출계약에서 정한 제지급금 지급사유가 발생한 때에는 회사는
              대출기간의 만료여부와 상관없이 해당 보험계약의 약관에서 정한 바에
              따라 제지급금에서 보험계약대출원리금을 공제하고 나머지 잔액을
              본인이나 보험금을 받는 자(보험수익자)등에 지급한다.
            </terms-typo>
          </base-messagebox>
          ...
          <base-messagebox :box="terms11">
            ...
            <terms-typo type="desc">
              ...
              주소 또는 연락처로 등기우편 등 우편물에 대한 기록이 남는 방법으로
              알린 사항은 일반적으로 도달이 필요한 시일이 지난 때에 계약자 또는
              보험수익자에게 도달한 것으로 본다. 단, 계약자에게 중대한 영향을
              미치는 중요한 의사표시인 경우에는 배달증명부내용증명에 의한 경우에
              한하여 도달한 것으로 본다.
            </terms-typo>
          </base-messagebox>
          <base-messagebox :box="terms12">
            ...
            <terms-typo type="bullet">
              ...
              2009.4.1 ~ 2010.3.31 : 상환일 + 1일(D+1) 기준가 - 2009.4.1 ~ 현재
              : 상환일 + 제2영업일(D+2) 기준가
            </terms-typo>
            <base-buttons
              type="gray-light"
        ...
        <section class="l-section">
          <base-messagebox :box="terms14">
            <terms-typo type="desc">
              보험계약대출 약정서의 [제4조 기한이익의 상실]에 의거, 대출원금 및
              이자 합계액이 해약환급금을 초과할 경우, 자동해약 될 수 있음을
              확인하셨습니까?
            </terms-typo>
            <base-buttons
              type="gray-light"
      ...
      <template #footer>
        <bottom-buttons :buttons="buttons" @hasdlePositive="onStep" />
      </template>
    </base-modal>
  </div>
</template>
