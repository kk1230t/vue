<template>
  <div class="l-content">
    <base-step :active="stepActive" :list="stepList" show-title>
      <template #content>
        <span
          >보험계약대출 이자 납부를 위해 본인 명의의 계좌를 입력해 주세요</span
        >
        <base-tooltip
          title="본인명의계좌"
          mode="skygray"
...
<script>
import Step1 from '@/components/mypage/atm/Step1'
import Step2 from '@/components/mypage/atm/Step2'
import Step3 from '@/components/mypage/atm/Step3'
import Step4 from '@/components/mypage/atm/Step4'
export default {
  ...
  methods: {
    onSuccess() {
      location.href = '/myPage/contractList/atm/done'
    }
  }
}
</script>
